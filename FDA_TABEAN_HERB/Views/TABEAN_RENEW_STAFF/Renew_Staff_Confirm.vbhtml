<form>
    <div class="row">
        ...
        <div class="col-sm-4">
            <div ng-hide="FULL_MODEL.STATUS_ID == 5 || FULL_MODEL.STATUS_ID == 3">
            ...
            <div ng-show="!(FULL_MODEL.STATUS_ID == 8|| FULL_MODEL.STATUS_ID == 7|| FULL_MODEL.STATUS_ID == 0||FULL_MODEL.STATUS_ID == 5||FULL_MODEL.STATUS_ID == 3)" style="text-align:center;">
            ...
            <div style="height: 5px;" ng-show="(FULL_MODEL.STATUS_ID == 3)"></div>
            <div ng-show="(FULL_MODEL.STATUS_ID == 3)" style="text-align:center;">
