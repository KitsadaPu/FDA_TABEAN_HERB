...
<div ng-controller="STAFF_REPLACEMENT_LCN_EDIT">
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-6" style="text-align:left">
            <input id="txt_name_search" type="text" ng-model="FULL_MODEL.NAME_SEARCH" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6" style="text-align:left">
            <input id="txt_iden_search" type="text" inputmode="" ng-model="FULL_MODEL.IDEN_SEARCH" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="table-responsive">
                <table ng-if="FILE_SEARCH != null && FILE_SEARCH.length != 0" class="table table-striped table-bordered table-hover dataTables-example">
                    <thead>
                        <tr>
    ...
    <div class="row" ng-if="CUSTOMER_FILE != null">
        <div class="col-md-1"></div>
        <div class="col-md-3">
            <h3>สถานที่</h3>
        </div>
                ...
                <table ng-if="CUSTOMER_FILE != null && CUSTOMER_FILE.length != 0" class="table table-striped table-bordered table-hover dataTables-example">
                    ...
                    <tbody>
                        <tr ng-repeat="x in CUSTOMER_FILE">
                            ...
                            <td style="color:#0033CC;text-decoration:underline;">
                                <a href="#" ng-click="BTN_REPLACE_CLICK(PROCESS_ID, 'active', x.IDA, x.CITIZEN_ID_AUTHORIZE, x)" style="color:#0033CC;">เลือก</a>
                            </td>
                        </tr>
                    </tbody>
                    <tfoot></tfoot>
