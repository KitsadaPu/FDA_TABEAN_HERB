    ...
    Public Class TABEAN_CENTER
        ...
        Public Class TABEAN_HERB_TBN
            ...
            Public Function gen_xml_tbn_2(ByVal _IDA As Integer, ByVal _IDA_DQ As Integer, ByVal _IDA_LCN As Integer)
                ...
                Return XML
            End Function
            Public Function gen_xml_tbn_2_new(ByVal Newcode As String)
                ...
                Try
                    ...
                    'Dim a As String = date_rgt_exdate_day.Day.ToString() - 1
                    'Dim b As String = date_rgt_date_rgt_exdate_monthmonth.ToString("MMMM")
                    'Dim c As String = con_year(date_rgt_exdate_year.Year) + 5

                    month = date_rgt_month.Month
                    monthName = thaiCulture.DateTimeFormat.GetMonthName(month)

                    XML.date_exdate_day = date_exdate_day.Day.ToString()
                    'XML.date_exdate_month = date_date_rgt_exdate_monthmonth.ToString("MMMM")
                    XML.date_exdate_month = monthName
                    XML.date_exdate_year = con_year(date_exdate_year.Year)
                    'XML.RGTNO_DATE_END = a & " " & b & " " & c
                Catch ex As Exception
