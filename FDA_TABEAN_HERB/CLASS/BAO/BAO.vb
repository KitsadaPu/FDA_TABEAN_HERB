...
Namespace BAO
    Public Class BAO
        ...
        Public Function SP_TABEAN_HERB_UPLOAD_FILE_JJ(ByVal TR_ID_JJ As Integer, ByVal TYPE_ID As Integer, ByVal P_ID As Integer, ByVal FK_IDA As Integer) As DataTable
            ...
            Return dt
        End Function
        Public Function SP_TABEAN_HERB_UPLOAD_FILE_CENTER(ByVal TR_ID_JJ As Integer, ByVal TYPE_ID As Integer, ByVal P_ID As Integer) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_TABEAN_HERB_UPLOAD_FILE_CENTER @TR_ID_JJ=" & TR_ID_JJ & ",@TYPE_ID= '" & TYPE_ID & "',@PROCESS_ID= '" & P_ID & "'"
            dt = Queryds(qstr)
