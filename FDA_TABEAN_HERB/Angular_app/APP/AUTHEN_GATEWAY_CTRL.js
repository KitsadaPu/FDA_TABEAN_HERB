app.controller('AUTHEN_GATEWAY_CTRL', function ($scope, $timeout, CENTER_SV) {
    runQuery2();
    pageload();
    ...
    function runQuery2() { //รับพารามิเตอร์จาก Query string
        ...
        //$scope.TOKEN = 'NnOkEB8wRPx2a7kXP9oGeAUU'
        $scope.PROCESS_ID = QueryString("Token");
        //$scope.PROCESS_ID = 20700;
...
/*        $scope.IDA_LCT = 53912;*/
    ...
    function SET_PATH_PAGE_MAIN(proces_id) {
        if ((proces_id == "20700") && ($scope.IDA_LCN !== "") && ($scope.IDA_LCT !== "") && ($scope.citizen_authen !== "")) {
            $scope.SET_MAIN_PAGE = "../TABEAN_SUBSTITUTE/Substitute_Choose_Tabean";
        } else if (proces_id == "20700") {
