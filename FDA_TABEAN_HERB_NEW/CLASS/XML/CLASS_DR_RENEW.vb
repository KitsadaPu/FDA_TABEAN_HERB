Public Class CLASS_DR_RENEW
    Inherits CLASS_CENTER
    Public TABEAN_RENEW As New TABEAN_RENEW
...
#End Region
    ...
    Public Property WRITEDATE_FULL_THAI() As String
        ...
        End Set
    End Property
    Private _DATE_CONFIRM_TH As String
    Public Property DATE_CONFIRM_TH() As String
        Get
            Return _DATE_CONFIRM_TH
        End Get
        Set(ByVal value As String)
            _DATE_CONFIRM_TH = value
        End Set
    End Property
