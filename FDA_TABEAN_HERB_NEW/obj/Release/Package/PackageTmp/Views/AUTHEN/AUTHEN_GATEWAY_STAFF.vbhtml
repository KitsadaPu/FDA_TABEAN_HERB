...
<head>
    ...
    <script src="~/Angular_app/APP/AUTHEN_GATEWAY_STAFF_CTRL.js"></script>
    <script src="~/Angular_App/CENTER_SV/CENTER_SV.js?v=1.0003"></script>
    <script src="~/Angular_app/LCN_EDIT_STAFF/LCN_EDIT_STAFF.js?v=1.0003"></script>
    <script src="~/Angular_app/LCN_EDIT_STAFF/STAFF_REPLACEMENT_LICENSE_MAIN.js?v=1.0003"></script>
    <script src="~/Angular_app/LCN_EDIT/LCN_EDIT.js?v=1.0003"></script>
    <script src="~/Angular_app/LCN_EDIT/LCN_EDIT_CONFIRM.js?v=1.0003"></script>
    <script src="~/Angular_app/LCN_EDIT/LCN_EDIT_ADD.js?v=1.0003"></script>
    <script src="~/Angular_app/TABEAN_SUBSTITUTE/Substitute_CTRL.js?v=1.0003"></script>
    <script src="~/Angular_app/TABEAN_SUBSTITUTE/Substitute_Staff_CTRL.js?v=1.0003"></script>
    <script src="~/Angular_app/TABEAN_SUBSTITUTE/Substitute_Add_CTRL.js?v=1.0003"></script>
    @*<script src="~/Angular_app/TABEAN_RENEW/Tabean_Renew_Staff.js?v=1.0003"></script>*@
    <script src="~/Angular_app/TABEAN_RENEW/Tabean_Renew_Staff.js"></script>
    <script src="~/Angular_app/TABEAN_RENEW/Tabean_Renew_Main.js?v=1.0003"></script>
    <script src="~/Angular_app/REPLACEMENT_STAFF/Replacement_Staff_Ctrl.js?v=1.0003"></script>
    <script src="~/Angular_app/TABEAN_RENEW/Tabean_Renew_Request.js?v=1.0003"></script>
    <script src="~/Angular_app/TABEAN_RENEW/Tabean_Renew_Upload.js?v=1.0003"></script>
    <style>
