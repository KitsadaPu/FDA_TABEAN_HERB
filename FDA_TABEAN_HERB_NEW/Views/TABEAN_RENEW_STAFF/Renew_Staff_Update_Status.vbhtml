<from>
    <div ng-hide="FULL_MODEL.STATUS_ID == 3 || FULL_MODEL.STATUS_ID == 31 || FULL_MODEL.STATUS_ID == 41">
        ...
        <div ng-show="FULL_MODEL.CONFIRM_STATUS_ID == 23">
            <div class="form-group">
                ...
                <select class="form-control" ng-model="FULL_MODEL.TABEAN_RENEW.SALE_CHANNEL_ID">
                    <option value=""  selected>กรุณาเลือก...</option>
            ...
            <div class="form-group">
                ...
                <select class="form-control" ng-model="FULL_MODEL.TABEAN_RENEW.KIND_ID">
                    <option value=""  selected>กรุณาเลือก...</option>
                    <option ng-repeat="x in FULL_MODEL.ddl_kind_tabean" ng-value="{{x.kindcd}}">{{x.thakindnm}}</option>
                </select>
            </div>
            <div class="form-group">
                <strong><label for="StatusStaff" style="text-align:left">รูปแบบผลิตภัณฑ์:</label></strong>
                <select class="form-control" ng-model="FULL_MODEL.TABEAN_RENEW.STYPE_ID">
                    <option value=""  selected>กรุณาเลือก...</option>
                    <option ng-repeat="x in FULL_MODEL.ddl_stype" ng-value="{{x.STYPE_ID}}">{{x.STYPE_NAME}}</option>
                </select>
            </div>
        </div>
    ...
    <div ng-show="(FULL_MODEL.STATUS_ID == 31||FULL_MODEL.STATUS_ID == 41)" ng-hide="true" style="text-align:center;">
