<div @*ng-controller="Tabean_Renew_EditFile_CTRL"*@>
        ...
        <div class="col-auto my-1">
            <div class="custom-control custom-checkbox mr-sm-2" required>
                <input type="checkbox" class="custom-control-input" 
                       id="Edit_Staff_File_Chk" 
                       ng-model="FULL_MODEL.TABEAN_RENEW.Edit_Staff_File_Chk"
                       ng-disabled="FULL_MODEL.STATUS_ID== 22">
    ...
    <div ng-show="FULL_MODEL.TABEAN_RENEW.Edit_Staff_Chk == true" style="padding-left:2em">
        <div class="custom-control custom-switch">
            <input type="checkbox" 
                   ...
                   id="customSwitch1" 
                   ng-model="FULL_MODEL.TABEAN_RENEW.Header_Edit_Person"
                   ng-disabled="FULL_MODEL.STATUS_ID== 22">
        ...
        <div class="custom-control custom-switch">
            <input type="checkbox" 
                   class="custom-control-input" 
                   id="customSwitch2" 
                   ng-model="FULL_MODEL.TABEAN_RENEW.Header_Edit_Location"
                   ng-disabled="FULL_MODEL.STATUS_ID== 22">
    ...
    <div class="row was-validated">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea id="exampleFormControlTextarea1" style="height:165px;min-height:165px" rows="3" ng-model="FULL_MODEL.TABEAN_RENEW.Note_Edit" class="form-control is-invalid" ng-readonly="FULL_MODEL.STATUS_ID== 22" ng-show="FULL_MODEL.STATUS_ID== 21 || FULL_MODEL.STATUS_ID== 22" placeholder="เหตุผลการขอแก้ไข" required></textarea>
            </div>
        </div>
    </div>
    <div style="height: 15px;"></div>
                    ...
                    <div class="input-group mb-2">
                        <div class="custom-file">
                            <input type="file"
                                   ...
                                   id="inputGroupFile01"
                                   ngf-select="Uploadattact(x.FileForUpload, x.index, x.TYPE, x.IDA, x.CITIZEN_ID, x.PROCESS_ID,$index, x)"
                                   ng-model="x.FileForUpload"
                                   ng-disabled="FULL_MODEL.STATUS_ID== 22">
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" 
                ng-click="BTN_SAVE_DATA_EDITFILE_CLICK(22)" 
                ng-disabled="FULL_MODEL.STATUS_ID== 22">Save</button>
    </div>
