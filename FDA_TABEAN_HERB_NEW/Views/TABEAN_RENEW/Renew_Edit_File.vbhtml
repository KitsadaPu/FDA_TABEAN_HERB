    ...
    <div class="row was-validated">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea id="exampleFormControlTextarea1" style="background-color: white; height:250px;min-height:165px" rows="3" ng-model="FULL_MODEL.TABEAN_RENEW.Note_Edit" class="form-control" placeholder="เหตุผลการขอแก้ไข" readonly></textarea>
            </div>
        </div>
    </div>
    <div style="height: 15px;"></div>
    <div ng-if="FULL_MODEL.FILE_ATTACH_STAFF != null && FULL_MODEL.FILE_ATTACH_STAFF.length != 0">
        <div class="form-row">
