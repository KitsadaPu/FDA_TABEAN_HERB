...
<div ng-controller="Tabean_Renew_Main">
            ...
            <tbody>
                ...
                <tr dir-paginate="x in filteredData = (Tabean_Herb |filter:search)  | itemsPerPage: 20">
                    ...
                    <td style="color:#0033CC;">
                        ...
                        <small id="SelectHelpBlock" class="form-text text-danger" ng-show="x.days_from_today < 0 && x.expdate_status == 'ไม่เกิน'">ยื่นคำขอโดยต้องเสียค่าปรับเนื่องจากการยื่นล่าช้าได้ไม่เกิน {{x.expdate_after}}</small>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="col-lg-12" style="color:red;">
                <p> 1. การยื่นคำขอจะแล้วเสร็จสมบูรณ์ เมื่อท่านชำระค่าคำขอแล้ว </p>
                <br /> <p>
                    2. เมื่อท่านชำระค่าคำขอและค่าธรรมเนียมแล้ว ใบสำคัญของท่านจะใช้ได้ต่อไปจนกว่าจะมีคำสั่งไม่ต่ออายุ
                </p> <br />
                <p>3. การยื่นคำขอโดยไม่เสียค่าปรับ ท่านต้องยื่นคำขอและชำระค่าคำขอให้แล้วเสร็จภายในเวลา 23.59 น. ของวันที่สิ้นอายุ </p> <br />
                <p>4. ในกรณีที่ท่านยื่นคำขอหลังวันสิ้นอายุ ท่านจะต้องชำระค่าธรรมเนียมการต่ออายุล่าช้าตามที่กฎหมายกำหนด ทั้งนี้การต่ออายุล่าช้าจะต้องยื่นภายใน 1 เดือนหลังสิ้นอายุ พร้อมหลักฐานแจ้งเหตุแห่งการต่ออายุล่าช้า </p> <br />
                <p>5. หากท่านไม่พบทะเบียนซึ่งท่านเป็นผู้ถือใบสำคัญ  โปรดติดต่อกองผลิตภัณฑ์สมุนไพร สำนักงานคณะกรรมการอาหารและยา โทร 02-5907000 ต่อ 71503 เพื่อสอบถาม </p>
                <p>6.หากไม่สามารถดูรายละเอียดได้โปรดตั้งค่า Browser ให้อนุญาตการใช้ ป๊อปอัพ/pop up" </p>
                <p>7.แนะนำให้ใช้ Firefox, Chrome และ Microsoft edge" </p>
            </div>
        </div>
    </div>
