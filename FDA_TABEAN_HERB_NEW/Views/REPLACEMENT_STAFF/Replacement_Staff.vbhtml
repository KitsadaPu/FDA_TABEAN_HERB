...
<div ng-controller="Replacement_Staff_Ctrl" style="padding-left:2em;padding-right:2em">
                    ...
                    <tbody>
                        <tr ng-repeat="x in FILE_SEARCH">
                            ...
                            <td style="color:#0033CC;text-decoration:underline;">
                                ...
                                <a href="#" ng-click="BTN_REPLACE_CLICK(PATH_NAME,PROCESS_ID, x.IDA, x.IDENTIFY, x)" style="color:#0033CC;">เลือก</a>
                            </td>
                        </tr>
                    </tbody>
                    <tfoot></tfoot>
