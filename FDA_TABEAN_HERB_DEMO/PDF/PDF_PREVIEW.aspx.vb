...
<<<<<<<< HEAD:FDA_TABEAN_HERB_NEW/PDF/PDF_PREVIEW.aspx.vb
        TBN_NEW = XML.gen_xml_tbn_2_new(Newcode, PROCESS_ID, IDA)
        If dao_r.fields.STATUS_ID <> 8 Then
            If Not String.IsNullOrEmpty(dao_r.fields.STYPE_NAME) AndAlso dao_r.fields.STYPE_NAME <> "-- กรุณาเลือก --" Then
                TBN_NEW.XML_DRUG_PRODUCT_HERB.thadsgnm = dao_r.fields.STYPE_NAME
            End If
            If Not String.IsNullOrEmpty(dao_r.fields.KIND_NAME) AndAlso dao_r.fields.KIND_NAME <> "-- กรุณาเลือก --" Then
                TBN_NEW.XML_DRUG_PRODUCT_HERB.thakindnm = dao_r.fields.KIND_NAME
            End If
            If Not String.IsNullOrEmpty(dao_r.fields.SALE_CHANNEL_NAME) AndAlso dao_r.fields.SALE_CHANNEL_NAME <> "-- กรุณาเลือก --" Then
                TBN_NEW.XML_DRUG_PRODUCT_HERB.sale_channel = dao_r.fields.SALE_CHANNEL_NAME
            End If
        End If
        If dao_r.fields.STATUS_ID = 8 Then
            Dim appDate As DateTime = dao_r.fields.appdate
            TBN_NEW.DATE_RENEW_TH = appDate.ToString("dd MMMM yyyy", New Globalization.CultureInfo("th-TH"))
        End If
========
        TBN_NEW = XML.gen_xml_tbn_2_new(Newcode, PROCESS_ID)
>>>>>>>> 5ea1ad78a7a4d702f4c22e17424ee87d07bc9d38:FDA_TABEAN_HERB_DEMO/PDF/PDF_PREVIEW.aspx.vb
        Dim YEAR As String = ""
...
<<<<<<<< HEAD:FDA_TABEAN_HERB_NEW/PDF/PDF_PREVIEW.aspx.vb
        ...
        'Else
        '    dao_pdftemplate.GetDataby_TEMPLAETE_and_P_ID_and_STATUS_and_PREVIEW_AND_GROUP(PROCESS_ID, dao_r.fields.STATUS_ID, 1, 1)
        'End If
