    ...
    Public Class TABEAN_CENTER
        ...
        Public Class TABEAN_HERB_TBN
            ...
            Public Function gen_xml_tbn_2(ByVal _IDA As Integer, ByVal _IDA_DQ As Integer, ByVal _IDA_LCN As Integer)
                ...
                Return XML
            End Function
<<<<<<<< HEAD:FDA_TABEAN_HERB_NEW/CLASS/CLASS_GEN_XML.vb
            Public Function gen_xml_tbn_2_new(ByVal Newcode As String, ByVal Process_ID As Integer, ByVal IDA As Integer)
========
            Public Function gen_xml_tbn_2_new(ByVal Newcode As String, ByVal Process_ID As Integer)
>>>>>>>> 5ea1ad78a7a4d702f4c22e17424ee87d07bc9d38:FDA_TABEAN_HERB_DEMO/CLASS/CLASS_GEN_XML.vb
                ...
                End If
<<<<<<<< HEAD:FDA_TABEAN_HERB_NEW/CLASS/CLASS_GEN_XML.vb
                If String.IsNullOrEmpty(dao.fields.tel_thanm) AndAlso dao.fields.tel_thanm = "" Then dao.fields.tel_thanm = dao_lcn.fields.tel
========
>>>>>>>> 5ea1ad78a7a4d702f4c22e17424ee87d07bc9d38:FDA_TABEAN_HERB_DEMO/CLASS/CLASS_GEN_XML.vb
...
<<<<<<<< HEAD:FDA_TABEAN_HERB_NEW/CLASS/CLASS_GEN_XML.vb
                    'Dim a As String = date_exdate_day.Day.ToString() - 1
========
>>>>>>>> 5ea1ad78a7a4d702f4c22e17424ee87d07bc9d38:FDA_TABEAN_HERB_DEMO/CLASS/CLASS_GEN_XML.vb
        ...
        Public Class TABEAN_RENEW
            ...
            Public Function Gen_XML_RENREW_TBN(ByVal IDA As Integer, ByVal FK_IDA As Integer, ByVal _IDA_LCN As Integer)
                ...
                dao.GetdatabyID_IDA(IDA)
                If dao.fields.TYPE_PERSON = 1 Then
                    'dao.fields.Age = Nothing
                    dao.fields.BSN_FULLNAME_TH = Nothing
                    dao.fields.BSN_IDENTIFY = Nothing
                    dao.fields.BSN_PREFIX_NM = Nothing
                    'dao.fields.Nation = Nothing
                End If
...
<<<<<<<< HEAD:FDA_TABEAN_HERB_NEW/CLASS/CLASS_GEN_XML.vb
                If _IDA_LCN = 0 Then _IDA_LCN = dao_licen.fields.IDA_dalcn
========
>>>>>>>> 5ea1ad78a7a4d702f4c22e17424ee87d07bc9d38:FDA_TABEAN_HERB_DEMO/CLASS/CLASS_GEN_XML.vb
                Dim dao_esub As New DAO_XML_DRUG_HERB.TB_XML_SEARCH_DRUG_LCN_HERB
                Try
                ...
                If TYPE_PERSON = 1 Then
                    If dao_drrqt.fields.WHO_ID = True Then
                        ...
                        For Each dr As DataRow In dt_lcn.Rows
                            ...
                            Try
                                'dr("PERSON_AGE") = person_age
                                dr("PERSON_AGE") = dao.fields.Age
                            Catch ex As Exception

                            End Try
                            Try
                                'dr("NATIONALITY_PERSON") = NATIONALITY_PERSON
                                dr("NATIONALITY_PERSON") = dao.fields.Nation
                            Catch ex As Exception
                    ...
                    Else
                        ...
                        For Each dr As DataRow In dt_lcn.Rows
                            ...
                            Try
                                'dr("CITIZEN_ID") = citizen_bsn
                                dr("CITIZEN_ID") = dao.fields.CITIZEN_ID
                            Catch ex As Exception

                            End Try
                            Try
                                dr("CITIZEN_ID_AUTHORIZE") = dao.fields.CITIZEN_ID_AUTHORIZE
                            Catch ex As Exception

                            End Try
                            Try
                                dr("NAME") = THANM_CENTER
                            Catch ex As Exception
                ...
                Else
                    ...
                    If dao_drrqt.fields.WHO_ID = True Then
                        If TYPE_PERSON_WHO = 1 Then
                            ...
                            dt_lcn.Columns.Add("PERSON_AGE")
                            dt_lcn.Columns.Add("NATIONALITY_PERSON")
                            dt_lcn.Columns.Add("BSN_THAIFULLNAME")
                            For Each dr As DataRow In dt_lcn.Rows
                                Try
                                    dr("NATION") = NATION
                                Catch ex As Exception
                                ...
                                Try
                                    'dr("CITIZEN_ID") = citizen_bsn
                                    dr("CITIZEN_ID") = dao.fields.BSN_IDENTIFY
                                Catch ex As Exception
                                ...
                                End Try
                                Try
                                    'dr("BSN_THAIFULLNAME") = dao.fields.BSN_FULLNAME_TH
                                    dr("BSN_THAIFULLNAME") = dao.fields.BSN_FULLNAME_TH
                                Catch ex As Exception
...
<<<<<<<< HEAD:FDA_TABEAN_HERB_NEW/CLASS/CLASS_GEN_XML.vb
                    'dao_lcn_HPI.GetDataby_IDA_and_PROCESS_ID(_IDA_LCN, 121)
                    dao_lcn_HPI.GetDataby_IDA(_IDA_LCN)
========
                    dao_lcn_HPI.GetDataby_IDA_and_PROCESS_ID(_IDA_LCN, 121)
>>>>>>>> 5ea1ad78a7a4d702f4c22e17424ee87d07bc9d38:FDA_TABEAN_HERB_DEMO/CLASS/CLASS_GEN_XML.vb
                    ...
                    dt_lcn_location.Columns.Add("BSN_THAIFULLNAME_HPI")
<<<<<<<< HEAD:FDA_TABEAN_HERB_NEW/CLASS/CLASS_GEN_XML.vb
                    dt_lcn_location.Columns.Add("FRGN_NAME")
                    dt_lcn_location.Columns.Add("FRGN_ADDR")
========
>>>>>>>> 5ea1ad78a7a4d702f4c22e17424ee87d07bc9d38:FDA_TABEAN_HERB_DEMO/CLASS/CLASS_GEN_XML.vb
...
<<<<<<<< HEAD:FDA_TABEAN_HERB_NEW/CLASS/CLASS_GEN_XML.vb
                            End If
                            dr("FRGN_NAME") = dao_product.fields.engfrgnnm
                            dr("FRGN_ADDR") = dao_product.fields.engfrgnnm_addr
========
...
>>>>>>>> 5ea1ad78a7a4d702f4c22e17424ee87d07bc9d38:FDA_TABEAN_HERB_DEMO/CLASS/CLASS_GEN_XML.vb
                ...
                ElseIf dao.fields.lcntpcd = "ผสม" Then
                    Dim dao_lcn_HPM As New DAO_LCN.TB_dalcn
<<<<<<<< HEAD:FDA_TABEAN_HERB_NEW/CLASS/CLASS_GEN_XML.vb
                    dao_lcn_HPM.GetDataby_IDA(_IDA_LCN)
                    'dao_lcn_HPM.GetDataby_IDA_and_PROCESS_ID(_IDA_LCN, 122)
========
                    dao_lcn_HPM.GetDataby_IDA_and_PROCESS_ID(_IDA_LCN, 122)
>>>>>>>> 5ea1ad78a7a4d702f4c22e17424ee87d07bc9d38:FDA_TABEAN_HERB_DEMO/CLASS/CLASS_GEN_XML.vb
