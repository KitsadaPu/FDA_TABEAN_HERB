Namespace DAO_XML_DRUG_HERB
    ...
    Public Class TB_XML_SEARCH_DRUG_LCN_HERB
        ...
        Public Sub GetDataby_lcnno_no(ByVal lcnno_no As String)
            ...
            Next
        End Sub
        Public Sub GetDataby_lcnno_no_New(ByVal lcnno_no_New As String)

            datas = (From p In db.XML_SEARCH_DRUG_LCN_HERBs Where p.lcnno_display_new = lcnno_no_New Select p)
            For Each Me.fields In datas
            Next
        End Sub
    End Class
