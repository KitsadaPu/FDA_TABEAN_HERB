Namespace DAO_TABEAN
    ...
    Public Class TB_TABEAN_RENEW
        ...
        Public Sub GetdatabyID_IDA(ByVal IDA As Integer)
            ...
            Next
        End Sub
        Public Sub Getdataby_Newcode_U(ByVal Newcode As String)
            datas = From p In db.TABEAN_RENEWs Where p.Newcode_U = Newcode And p.ACTIVEFACT = True Select p
            For Each Me.fields In datas
    ...
    Public Class TB_TABEAN_HERB_UPLOADFILE_HIS
        ...
        End Sub
    End Class
<<<<<<<< HEAD:FDA_TABEAN_HERB_NEW/CLASS/DAO/DAO_TABEAN.vb
    Public Class TB_Mas_Sending_Information_Customer
        Inherits MAINCONTEXT

        Public fields As New Mas_Sending_Information_Customer

        Public Sub insert()
            db.Mas_Sending_Information_Customers.InsertOnSubmit(fields)
            db.SubmitChanges()
        End Sub
        ...
        Public Sub Delete()
            db.Mas_Sending_Information_Customers.DeleteOnSubmit(fields)
            db.SubmitChanges()
        End Sub
        Public Sub GetAll()
            datas = (From p In db.Mas_Sending_Information_Customers Where p.ACTIVE = True Select p)

        End Sub
        Public Sub Getdataby_Process_ID(ByVal Process_ID As Integer)
            datas = From p In db.Mas_Sending_Information_Customers Where p.Process_ID = Process_ID And p.ACTIVE = True Select p
            For Each Me.fields In datas
        ...
        Public Sub Getdataby_Process_id_And_Type_id(ByVal Process_ID As Integer, ByVal Type_ID As Integer)
            ...
            Next
        End Sub
        Public Sub Getdataby_Process_ID_And_Status_ID(ByVal Process_ID As Integer, ByVal SSID As Integer)
            datas = From p In db.Mas_Sending_Information_Customers Where p.Process_ID = Process_ID And p.Status_ID = SSID And p.ACTIVE = True Select p
            For Each Me.fields In datas

            Next
        End Sub
        Public Sub GetdatabyID_ID(ByVal ID As Integer)
            datas = From p In db.Mas_Sending_Information_Customers Where p.ID = ID And p.ACTIVE = True Select p
            For Each Me.fields In datas
    ...
    End Class
========
>>>>>>>> 5ea1ad78a7a4d702f4c22e17424ee87d07bc9d38:FDA_TABEAN_HERB_DEMO/CLASS/DAO/DAO_TABEAN.vb
