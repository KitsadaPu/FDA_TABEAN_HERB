                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab" @*ng-show="Page == 1"*@>
                        ...
                        <div class="needs-validation" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" 
                                       class="form-control" 
                                       id="validationTxt_email_Appoinment" 
                                       ng-model="FULL_MODEL.TABEAN_RENEW.Appoinment_Email" 
                                       ng-readonly="FULL_MODEL.STATUS_ID >= 2"
                                       title="กรุณากรอกข้อมูลรูปแบบ e-mail ให้ถูกต้อง">
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <i style="color:red" ng-show="FULL_MODEL.STATUS_ID == 1 || FULL_MODEL.STATUS_ID == 2">*</i>
                                <input type="tel"
                                       class="form-control"
                                       id="validationtxt_Phone_Appoinment"
                                       ng-model="FULL_MODEL.TABEAN_RENEW.Appoinment_Phone"
                                       ng-readonly="FULL_MODEL.STATUS_ID >= 2"
                                       pattern="\d{10}"
