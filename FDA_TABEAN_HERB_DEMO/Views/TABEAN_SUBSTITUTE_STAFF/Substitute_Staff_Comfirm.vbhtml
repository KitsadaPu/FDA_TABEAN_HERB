    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div ng-hide="FULL_MODEL.STATUS_ID == 5">
                ...
                <div class="row"  id="st702">
                    <div style="height:15px"></div>
                    <div class="col-md-6">ลงวันที่:</div>
                    <div class="col-md-6"> <input type="date" name="date_offer" id="date_offer" ng-model="FULL_MODEL.DATE_CONNFIRM" class="form-control datepicker hasDatepicker"></div>
                </div>
