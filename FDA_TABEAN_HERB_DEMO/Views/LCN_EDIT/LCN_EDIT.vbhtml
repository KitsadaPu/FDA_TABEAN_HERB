...
<div ng-controller="LCN_EDIT">
    ...
    <div class="row">
        <div class="col-md-12" style="text-align:right">
            ...
            <input type="button" style="Height: 47px;Width: 250px; background-color: #1ab394;border-radius:3px" value="สร้างคำขอใหม่" ng-click="BTN_ADD_LCN_EDIT_CLICK('../LCN_EDIT/LCN_EDIT_ADD', 'active', IDA_LCN, cer_dalcn_herb)" />
        </div>
    </div>
    <div style="height: 15px;"></div>
    <div class="table-responsive">
        <table ng-if="lcn_edit != null && lcn_edit.length != 0" class="table table-striped table-bordered table-hover dataTables-example" id="tb_lcn_staff">
            <thead>
                <tr>
