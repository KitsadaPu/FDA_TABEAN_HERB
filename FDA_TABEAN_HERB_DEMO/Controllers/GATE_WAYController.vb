            ...
            Try
                ...
                For i = 0 To ar.Length - 1
                    Select Case ar(i)
                        ...
                        Case "FUNC-GET_DATA_TABEAN_HERB_RENEW"
                            MODEL_APP = CORE_FUNC.GET_DATA_TABEAN_HERB_RENEW(MODEL_APP)
                        ...
                        Case "FUNC-GET_DATA_CONFIRM_RENEW"
                            ...
                            MODEL_APP = CORE_FUNC.GetDataDDL_Type_Request(MODEL_APP)
                        ...
                        Case "FUNC-GET_FILE_TABEAN_RENEW"
                            MODEL_APP = CORE_FUNC.GET_FILE_UPLOAD_TABEAN_CENNTER(MODEL_APP)
                        Case "FUNC-GET_DATA_TABEAN_RENEW_EDIT_FILE"
                            MODEL_APP = CORE_FUNC.GET_FILE_UPLOAD_TABEAN_CENNTER(MODEL_APP)
                        Case "FUNC-GET_EDIT_FILE_STAFF_UPLOAD"
                            MODEL_APP = CORE_FUNC.GET_FILE_UPLOAD_TABEAN_EDIT_CENNTER(MODEL_APP)
                            'MODEL_APP = CORE_FUNC.GET_EDIT_FILE_STAFF_UPLOAD(MODEL_APP)
                            MODEL_APP = CORE_FUNC.GET_DATA_EDIT_STAFF(MODEL_APP)
                        Case "FUNC-GET-DATA_EDIT_FILE_TABEAN_RENEW"
                            'MODEL_APP = CORE_FUNC.GET_FILE_UPLOAD_TABEAN_EDIT_CENNTER(MODEL_APP)
                            MODEL_APP = CORE_FUNC.GET_EDIT_FILE_STAFF_UPLOAD_USER(MODEL_APP)
                            MODEL_APP = CORE_FUNC.GET_DATA_TABEAN_HERB_RENEW(MODEL_APP)
                            MODEL_APP = CORE_FUNC.GET_DATA_EDIT_STAFF(MODEL_APP)
                        Case "FUNC-SEARCH_LCN_LOCATION"
                            MODEL_APP = CORE_FUNC.SEARCH_LCN_LOCATION(MODEL_APP)
                        Case "FUNC-CHECK_FILE_UPLOADS"
                            MODEL_APP.ALERT_MS = CORE_FUNC.Check_File_Uploads(MODEL_APP)
                        ...
                        Case "FUNC-ADD_REQUEST_TABEAN_RENEW"
                            MODEL_APP = CORE_FUNC.INSET_REQUEST_TABEAN_RENEW(MODEL_APP)
                        ...
                        Case "FUNC-UPDATE_CONFIRM_EDIT_STAFF"
                            MODEL_APP = CORE_FUNC.UpdateDataStaffTabeanRenewConfirm(MODEL_APP)
