...
<form class="needs-validation" novalidate>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="validationTxt_name_appoinment" ng-model="FULL_MODEL.TABEAN_HERB_SUBSTITUTE.Appoinment_Contact">
    ...
    <div class="form-group">
        ...
        <input type="email" class="form-control" id="validationTxt_email_Appoinment" ng-model="FULL_MODEL.TABEAN_HERB_SUBSTITUTE.Appoinment_Email">
        <div class="invalid-feedback">
    ...
    <div class="form-group">
        ...
        <input type="tel" class="form-control" id="validationtxt_Phone_Appoinment" ng-model="FULL_MODEL.TABEAN_HERB_SUBSTITUTE.Appoinment_Phone">
        <div class="invalid-feedback">
    ...
    <div class="form-group">
        ...
        <select class="custom-select mr-sm-2" id="validationInputDiscount" ng-model="FULL_MODEL.TABEAN_HERB_SUBSTITUTE.Discount_RequestID" ng-change="fil_req_ddl_discount()">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" id="txt_Discount_Detail" ng-model="FULL_MODEL.TABEAN_HERB_SUBSTITUTE.Discount_Detail"></textarea>
    </div>
</form>
